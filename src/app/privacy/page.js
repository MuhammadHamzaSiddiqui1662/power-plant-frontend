            ...
            <div className="md:w-3/4">
              <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                ...
                <p className="text-slate-400">
                  Welcome to Power Plant. We are committed to protecting your
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  <li className="flex mt-2">
                    ...
                    />
                    <b>Personal Information:</b> When you register on our
                    platform, we collect personal information such as your name,
                  ...
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>Usage Data:</b> We collect information on how you access
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>To Provide and Maintain Our Service: </b> We use your
                    information to deliver and improve our services, manage your
                  ...
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>To Communicate with You: </b> We may use your personal
                  ...
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>To Improve Our Services: </b> Usage data helps us
                    understand how users interact with our platform, enabling us
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  ...
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>Business Transfers: </b> If Power Plant is involved in a
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  <li className="flex mt-2">
                    ...
                    update your personal information at any time through your
                    account settings.
                  </li>
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                  ...
                  <li className="flex mt-2">
                    <Unicons.UilArrowRight
                      ...
                      className="text-green-600 align-middle me-2"
                    />
                    <b>Objection: </b> You have the right to object to the
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  <li className="flex mt-2">
                    ...
                    contact us at: ● Email: contact@powerplant.com ● Address:
                    Power Plant, Plot-4, Northwest Freeway, Suite 420, Berlin,
                    Germany
                  </li>
                </ul>
                ...
                <ul className="list-unstyled text-slate-400 mt-4">
                  <li className="flex mt-2">
                    ...
                    of this Privacy Policy. Thank you for trusting Power Plant
