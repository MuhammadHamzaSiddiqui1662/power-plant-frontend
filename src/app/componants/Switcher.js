    ...
    return (
        <>
            ...
            <div className="fixed top-1/4 -left-2 z-3">
                <span className="relative inline-block rotate-90">
                    ...
                    <label className="label bg-slate-900 dark:bg-white shadow dark:shadow-gray-700 cursor-pointer rounded-full flex justify-between items-center p-1 w-14 h-8" htmlFor="chk">
                        <Unicons.UilMoon className="text-yellow-500" width={18}/>
                        <Unicons.UilSun className="text-yellow-500" width={18}/>
            ...
            <Link  href="#" onClick={scrollToTop}
                id="back-to-top" className={`${!scrollToTops ? "hidden":"back-to-top fixed text-lg rounded-full z-10 bottom-5 end-5 h-9 w-9 text-center bg-green-600 text-white justify-center items-center flex"}`}><Unicons.UilArrowUp width={18}/></Link>
            {/* <!-- LTR & RTL Mode Code --> */}
