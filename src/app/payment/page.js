            ...
            <Card className="subscriber-fee-card">
                  ...
                  <Col>
                    {/* {selectedCardType === 2 ? (
                      <Badge color="green" offset={[-5, 2]} count={"✓"}>
                        <Card
                          key={2}
                          className="paypal-card active"
                          onClick={() => paypalClick(2)}
                        >
                          <Image
                            preview={false}
                            width={60}
                  ...
                  <Col>
                    {/* {selectedCardType === 3 ? (
                      <Badge color="green" offset={[-5, 2]} count={"✓"}>
                        <Card
                          key={3}
                          className="stripe-card active"
                          onClick={() => stripeClick(3)}
                        >
                          <Image
                            preview={false}
                            width={50}
              ...
              <Row>
                ...
                <Col span={11} offset={1}>
                  ...
                  <Input placeholder="Type 3-digits here" />
                </Col>
              </Row>
            </Card>
          </Col>
          ...
          <Col xs={22} md={20} lg={10} xl={7} xxl={6} className="mt-40">
            <Card className="payment-card" bordered={false}>
              <Typography>
                ...
                <Row>
                  <Col span={8} offset={1}>
                    <Text className="f-16 b-5xx">{_package.title}</Text>
                  </Col>
                  <Col span={6} offset={9}>
                    <Text className="f-16 b-5xx">${_package.amount}</Text>
                  </Col>
                </Row>
                <Divider />
                <Row>
                  ...
                  <Col span={6} offset={11}>
                    <Title className="f-18 b-5xx">${_package.amount}</Title>
                  </Col>
                </Row>
                <Row>
                  <Col span={6} offset={1}>
              ...
              <Col span={4} offset={13}>
                <Button
                  ...
                  type="primary"
                >
                  <text className="f-16">Pay Now</text>
                </Button>
              </Col>
            </Card>
          </Col>
